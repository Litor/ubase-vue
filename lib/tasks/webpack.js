...
_gulp2.default.task('webpack', function () {
  return _gulp2.default.src([]).pipe(_gulpEnv2.default.set(envs)).pipe((0, _errorHandler2.default)()).pipe((0, _vinylNamed2.default)()).pipe((0, _webpackStream2.default)(_webpack2.default)).pipe(_gulp2.default.dest(_config2.default.argDist || _config2.default.dest)).on('end', function () {
