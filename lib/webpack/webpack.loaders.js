...
loaders.js = {
  test: /\.js$/i,
  include: [_path2.default.resolve(_config2.default.src), _path2.default.resolve('./node_modules/bh-vue'), _path2.default.resolve('./node_modules/wec-vue')],
  loader: 'babel'
};

loaders.js1 = {
  test: /\.js$/i,
  include: (0, _utils.getEntryFilePath)(),
...
loaders.configjson = {
  ...
  loader: 'file',
  query: {
    context: _path2.default.resolve(_config2.default.pages),
    name: '[path][name].[ext]'
  }
};
...
loaders.i18n = {
  ...
  loader: 'file',
  query: {
    context: (0, _utils.getEntryFilePath)(),
    name: '[path][name].[ext]'
  }
};
